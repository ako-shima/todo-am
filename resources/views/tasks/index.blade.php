...
<div class="sort-links">
    <a href="{{ route('tasks.index', ['sort' => 'created_at', 'direction' => 'desc']) }}">NEW<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sort-up" viewBox="0 0 16 16">
...
<section class="tw-text-gray-600 tw-body-font">
  ...
  <div class="tw-container tw-px-5 tw-py-24 tw-mx-auto">
      ...
      @endforeach
      <button   class="add-post tw-flex ml-auto tw-text-black  tw-border-0 tw-py-2 tw-px-2 tw-focus:outline-none tw-rounded tw-text-8xl" onclick="window.location='{{ route('tasks.create') }}'">+</button>
  </div>
</section>
