...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div style="display: flex">
          <a href="{{ route('tasks.edit', $task->id) }}" class="btn btn-lg">
          ...
          <form action="{{ route('tasks.destroy', $task->id) }}" method="post">
            @csrf
            @method('delete')
            <button type="submit" class="btn btn-lg" onclick='return confirm("Do you really want to delete this？");'>
          ...
          <a href="{{ route('tasks.index') }}" class="btn btn-lg">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-bookmark-check" viewBox="0 0 16 16">
              ...
              {{-- <div class="flex space-x-4">
                ...
                <a href="{{ route('tasks.index') }}" class="btn btn-lg" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-check" viewBox="0 0 16 16">
                  <path fill-rule="evenodd" d="M10.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0"/>
                  <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1z"/>
                </svg></a>
              </div> --}}
    ...
    <div class="row justify-content-center">
      <div class="col-md-8 mt-5">
        ...
        @foreach($task->comments as $comment)
          <div class="card mt-3">
              <h5 class="card-header">Poster：{{ $comment->user->name }}</h5>
              <div class="card-body">
                  <h5 class="card-title">Date & Time：{{ $comment->created_at }}</h5>
